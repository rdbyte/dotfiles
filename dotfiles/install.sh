...
gitorigin="https://github.com/rdbyte/dotfiles.git"
debug=false

# configurations this script knows how to setup
declare -a configurations=("all" "none" "zsh" "vim" "tmux" "gdb", "deps")
...
function install_deps() {
    echo_green "installing deps and others modules"
    sudo apt install bat gron openvpn zsh git keepassx \
    python3-pip vim -y
    echo_green "> deps install complete!"
}
